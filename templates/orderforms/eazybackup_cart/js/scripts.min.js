...
function elementOutOfViewPort(e) {
    ...
    return (
        (t.top = e.top < 0),
        (t.left = e.left < 0),
        (t.bottom = e.bottom > (window.innerHeight || document.documentElement.clientHeight)),
        (t.right = e.right > (window.innerWidth || document.documentElement.clientWidth)),
...
!(function (g) {
    ...
    function A(e, t, n) {
        var i = e[0],
            ...
            r = n == S ? { checked: i[w], disabled: i[Q], indeterminate: "true" == e.attr(k) || "false" == e.attr(f) } : i[a];
        if (/^(ch|di|in)/.test(n) && !r) P(e, a);
        else if (/^(un|en|de)/.test(n) && r) I(e, a);
        else if (n == S) for (var o in r) (r[o] ? P : I)(e, o, !0);
        else (t && "toggle" != n) || (t || e[U]("ifClicked"), r ? i[M] !== C && I(e, a) : P(e, a));
    }
    function P(e, t, n) {
        var i,
            a,
        ...
        !0 !== r[t] &&
            (!n &&
                ...
                (a = i.length ? i.find(a) : g(a)).each(function () {
                    this !== r && g(this).data(j) && I(g(this), t);
                })),
            d ? ((r[t] = !0), r[w] && I(e, w, "force")) : (n || (r[t] = !0), s && r[k] && I(e, k, !1)),
            O(e, s, t, n)),
            r[Q] && y(e, m, !0) && o.find("." + v).css(m, "default"),
            o[T](h || y(e, t) || ""),
            o.attr("role") && !d && o.attr("aria-" + (l ? Q : w), "true"),
            o[R](c || y(e, u) || "");
    }
    function I(e, t, n) {
        var i = e[0],
        ...
        !1 !== i[t] && ((!o && n && "force" != n) || (i[t] = !1), O(e, r, d, n)),
            !i[Q] && y(e, m, !0) && a.find("." + v).css(m, "pointer"),
            a[R](u || y(e, t) || ""),
            a.attr("role") && !o && a.attr("aria-" + (s ? Q : w), "false"),
            a[T](l || y(e, d) || "");
    }
    function L(e, t) {
        e.data(j) &&
    ...
    g.fn[j] = function (t, n) {
        ...
        var u,
            ...
            r = g();
        return /^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(t)
            ? ((t = t.toLowerCase()),
              e(this),
              r.each(function () {
                  var e = g(this);
            ...
            : "object" != typeof t && t
            ? this
            : ((i = (u = g.extend({ checkedClass: w, disabledClass: Q, indeterminateClass: k, labelHover: !0 }, t)).handle),
              ...
              r.each(function () {
                  var i = g(this),
                      ...
                      t = -y + "%",
                      n = 100 + 2 * y + "%",
                      t = { position: "absolute", top: t, left: t, display: "block", width: n, height: n, margin: 0, padding: 0, background: "#fff", border: 0, opacity: 0 },
                      n = W ? { position: "absolute", visibility: "hidden" } : y ? t : { position: "absolute", opacity: 0 },
                      r = a[M] == b ? u.checkboxClass || "i" + b : u.radioClass || "i" + C,
                  ...
                  s &&
                      ...
                      i.on(x + ".i focus.i blur.i keyup.i keydown.i keypress.i", function (e) {
                          var t = e[M],
                              e = e.keyCode;
                          return t != x && ("keydown" == t && 32 == e ? ((a[M] == C && a[w]) || (a[w] ? I : P)(i, w), !1) : void ("keyup" == t && a[M] == C ? a[w] || P(i, w) : /us|ur/.test(t) && l["blur" == t ? R : T](h)));
                      }),
                ...
                return (
                    ...
                    (this.preLinkInit = function (e) {
                        this.feedbackContainer()
                            ...
                            .html('<i class="fas fa-fw fa-spinner fa-spin"></i> ' + this.feedbackMessage())
                            .hide();
                        var t,
                            n = this.btnContainer();
                        n.length
                            ? n.data("hideOnPrelink")
                                ...
                                : (n.data("disableOnPrelink") && n.find(".btn").addClass("disabled"), this.showProgressMessage(e))
                    ...
                    (this.displaySuccess = function (e, t, n) {
                        ...
                        switch (e.result) {
                            ...
                            case "login_to_link":
                                s === d
                                    ? ((c = this.feedbackMessage("login_to_link-signin-required")),
                                      this.feedbackContainer()
                                          .removeClass("alert-danger alert-success alert-info")
                                          .addClass("alert alert-warning")
                                          .html(o + c))
                                    : ((h = jQuery("input[name=email]")),
                                      (i = jQuery("input[name=firstname]")),
                                      (a = jQuery("input[name=lastname]")),
                                      "" === h.val() && h.val(e.remote_account.email),
                                      ...
                                      s === l
                                          ? ("object" == typeof WHMCS.client.registration && WHMCS.client.registration.prefillPassword(),
                                            (c = this.feedbackMessage("login_to_link-registration-required")),
                                          ...
                                          : ("object" == typeof WHMCS.client.registration && WHMCS.client.registration.prefillPassword(),
                                            (r = this).feedbackContainer().each(function (e, t) {
                                                ...
                                                n.fadeOut("slow", function () {
                                                    (c = "checkout-new" === i ? r.feedbackMessage("checkout-new") : r.feedbackMessage("login_to_link-signin-required")),
                                                        n
                                                            .removeClass("alert-danger alert-success alert-info")
                                                            .addClass("alert alert-warning")
                                                            .html(o + c)
            ...
            return (
                (this.prefillPassword = function (i) {
                    ...
                    void 0 === (i = i || {}).hideContainer
                        ? ((t = jQuery("#inputSecurityQId").attr("id") ? "#containerPassword" : "#containerNewUserSecurity"), (i.hideContainer = jQuery(t)), (i.hideInputs = !0))
                        : "string" == typeof i.hideContainer && i.hideContainer.length && (i.hideContainer = jQuery(i.hideContainer)),
                        void 0 === i.form && (i.form = { password: [{ id: "inputNewPassword1" }, { id: "inputNewPassword2" }] });
                ...
                (this.jsonGet = function (n) {
                    (n = n || {}),
                        this.get(
                            ...
                            function (e) {
                                e.warning
                                    ? (console.log("[WHMCS] Warning: " + e.warning), "function" == typeof n.warning && n.warning(e.warning))
                                    : e.error
                                    ? (console.log("[WHMCS] Error: " + e.error), "function" == typeof n.error && n.error(e.error))
        ...
        WHMCS.loadModule("ui", {
            confirmation: function () {
                ...
                return (
                    (this.register = function (e) {
                        return t.indexOf((e = void 0 === e ? "[data-toggle=confirmation]" : e)) < 0 && t.push(e), jQuery(e).confirmation({ rootSelector: e }), t;
                    }),
                    this
                );
            },
                            ...
                            void 0 === a.tables[e]
                                ? (void 0 === n &&
                                      (n = {
                                          ...
                                          language: { emptyTable: r.data("langEmptyTable") ? r.data("langEmptyTable") : "No records found" },
                                      }),
                                  jQuery.each(r.data(), function (e, t) {
                                      void 0 !== t &&
                                          ("ajaxUrl" === e
                                              ...
                                              ? (n.pageLength = t)
                                              : "langEmptyTable" === e
                                              ? (void 0 === n.language && (n.language = {}), (n.language.emptyTable = t))
                                              : "langZeroRecords" === e
                                              ? (void 0 === n.language && (n.language = {}), (n.language.zeroRecords = t))
                                              : (n.key = t));
                                  }),
                                ...
                                : void 0 !== n && ((i = (t = a.tables[e]).init()), (i = jQuery.extend(i, n)), t.destroy(), (a.tables[e] = a.initTable(r, i))),
                            a.tables[e]
                        );
                    }),
            ...
            clipboard: function () {
                return (
                    (this.copy = function (e) {
                        ...
                        e.tooltip({ trigger: "click", placement: "bottom" }), WHMCS.ui.toolTip.setTip(e, "Copied!"), WHMCS.ui.toolTip.hideTip(e);
                    }),
                    this
                );
            },
                        ...
                        n.initFields(t),
                            $(t).on("submit", function (e) {
                                ...
                                $(e).length &&
                                    ...
                                    WHMCS.http.client
                                        .post({ url: $(t).attr("action"), data: $(t).serializeArray() })
                                        .done(function (e) {
                                            n.onSuccess(t, e);
                                        })
                                        .fail(function (e) {
                        ...
                        for (i in t)
                            t.hasOwnProperty(i) && (a = t[i]),
                                (n = this.managedElements
                                    ...
                                    .join(",")),
                                (n = $(e).find(n)),
                                a && ($(n).parents(".form-group").addClass("has-error"), $(n).attr("title", a), $(n).tooltip());
            ...
            effects: function () {
                this.errorShake = function (e) {
                    var d = {},
                        d = $.extend({ direction: "left", distance: 8, times: 3, speed: 90 }, d);
                    return e.each(function () {
                        var e = $(this),
                            t = { position: e.css("position"), top: e.css("top"), bottom: e.css("bottom"), left: e.css("left"), right: e.css("right") },
...
function setRecommendationColors() {
    ...
    jQuery(".product-recommendations .product-recommendation").each(function () {
        var e = jQuery(this),
            t = e.data("color");
        (0 < t.length && null != t.match(/^#[0-9A-Fa-f]{3,6}$/gi)) || (t = "#9abb3a"),
...
function displayRecommendations(e, t, n) {
    ...
    return (
        n || a
            ? (jQuery('.cart-body button[type="submit"] i').removeClass("fa-arrow-circle-right").addClass("fa-spinner fa-spin"),
...
WHMCS.hasModule("recaptcha") ||
            ...
            (this.register = function () {
                ...
                e.each(function (e, t) {
                    ...
                    var n = jQuery(t),
                        ...
                        a = typeof recaptcha.requiredText !== "undefined" ? recaptcha.requiredText : "Required",
                    ...
                    if (!c) o.data("toggle", "tooltip").data("placement", "bottom").data("trigger", "manual").attr("title", a).hide();
                    var l = r + "Callback";
                    window[l] = function () {
                        if (c) n.submit();
                    };
                    if (c) {
                        ...
                        n.on("submit.recaptcha", function (e) {
                            ...
                            if (!window[recaptcha.apiObject].getResponse(t).trim()) {
                                e.preventDefault();
                                window[recaptcha.apiObject].execute(t);
                ...
                window.recaptchaLoadCallback = function () {
                    jQuery(".g-recaptcha").each(function (e, t) {
                        ...
                        var o = grecaptcha.render(t, { sitekey: recaptcha.siteKey, size: a.hasClass("btn-recaptcha-invisible") ? "invisible" : "normal", callback: r + "Callback" });
                        n.data("recaptcha-id", o);
                    });
                };
                if (e.length)
                    jQuery.getScript(recaptcha.libUrl, function () {
                        for (var e = u.length - 1; e >= 0; e--) u[e]();
                    });
                let t = jQuery(".captcha-overlay-badge"),
            ...
            return (
                (this.simpleRNG = function () {
                    ...
                    for (var a = 0; a < t; a++) {
                        ...
                        if (Math.random() > 0.5) i += e.substr(Math.floor(Math.random() * 13), 1);
                    }
                    return i;
                }),
    ...
    jQuery(document).ready(function () {
        jQuery("#main-body")
            .on("click", ".product-recommendations .product-recommendation .header", function (e) {
                jQuery(e.target).is(".btn, .btn span, .btn .fa") ||
                    (e.preventDefault(), 0 < jQuery(".fa-square", this).length) ||
                    (jQuery(this).parent().find(".rotate").toggleClass("down"), jQuery(this).parent().find(".body").slideToggle("fast"));
            })
            ...
            setRecommendationColors(),
            (document.URL.includes("cart.php?a=checkout") || document.URL.includes("cart.php?a=view")) && 0 < jQuery("#recommendationsModal .product-recommendation:not(.clonable)").length && jQuery("#recommendationsModal").modal("toggle");
    }),
    ...
    checkoutForm.find(".form-group").removeClass("has-error"),
        ...
        o &&
            ...
            "new" === t &&
                ...
                (jQuery.payment.validateCardNumber(checkoutForm.find("#inputCardNumber").val()) && !s.hasClass("unsupported")) ||
                    ((r = s.data("message-invalid")), s.hasClass("unsupported") && (r = s.data("message-unsupported")), checkoutForm.find("#inputCardNumber").setInputError(r).showInputError(), (a = !1)),
            ...
            o.is(":visible") && !jQuery.payment.validateCardCVC(o.val(), i) && (o.showInputError(), (a = !1)),
            a || (n.prop("disabled", !1).removeClass("disabled").find("i").removeAttr("class").addClass("fas fa-arrow-circle-right"), e.preventDefault()));
}
...
function recalctotals() {
    ...
    e.done(function (e) {
        ...
        e.always(function () {
            jQuery("#orderSummaryLoader").delay(0).fadeOut("fast");
        });
}
...
function selectDomainPeriodInCart(e, t, n, i) {
    var a = jQuery("#orderSummaryLoader"),
        i =
            ...
            jQuery("[name='" + e + "Pricing']").html(n + " " + i + ' <span class="caret"></span>'),
            jQuery("[name='" + e + "Price']").html(t),
            WHMCS.http.jqClient.post(window.location.pathname, { domain: e, period: n, a: "updateDomainPeriod", token: csrfToken }));
    i.done(function (e) {
        e.forceReload
            ...
            : (e.domains.forEach(function (e) {
              ...
              jQuery("#recurring").find("span:visible").not("span.cost").fadeOut("fast"),
...
function validate_captcha(t) {
    let e = jQuery("#g-recaptcha-response"),
    ...
    return e.length && !e.val()
        ...
        : i.length && !i.val()
        ? (i.tooltip("show"), !1)
        : void WHMCS.http.jqClient.post(t.attr("action"), t.serialize() + "&a=validateCaptcha", null, "json").done(function (e) {
              e.error
                  ? (jQuery("#inputCaptcha, .recaptcha-container").attr("data-original-title", e.error).tooltip("show"),
...
jQuery(document).ready(function () {
    ...
    var a,
        ...
        s =
            (e.length && (e.payment("formatCardNumber"), jQuery("#inputCardCVV").payment("formatCardCVC"), jQuery("#inputCardStart").payment("formatCardExpiry"), jQuery("#inputCardExpiry").payment("formatCardExpiry")),
            t.length && t.payment("formatCardCVC"),
            jQuery("#orderSummary"));
    function n() {
        var e, t, n, i;
        "none" === jQuery("#scrollingPanelContainer").css("float")
            ? s.stop().css("margin-top", "0")
            : ((e = s.outerHeight()),
              (t = 0),
              (n = jQuery("#scrollingPanelContainer").prev("div.secondary-cart-body")),
              void 0 !== a && (t = a.top),
              (i = jQuery(window).scrollTop() - t + o),
              e < jQuery(window).height()
                  ? (n.stop().animate({ marginTop: 0 }), r - e < i && (i = r - e), jQuery(window).scrollTop() > t ? s.stop().animate({ marginTop: i }) : s.stop().animate({ marginTop: 0 }))
                  : (s.stop().animate({ marginTop: 0 }), i + n.height() > s.height() || (jQuery(window).scrollTop() > t ? n.stop().animate({ marginTop: i }) : n.stop().animate({ marginTop: 0 }))));
    }
    s.length &&
        ...
        jQuery("#frmConfigureProduct").submit(function (e) {
            ...
            jQuery("#submitButtonIcon")
                .removeClass("fa-arrow-circle-right")
                .html(
                    '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 ml-2 spinner"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"></path></svg>'
                );
        
            displayRecommendations(n, "addproductajax=1&" + i, !1).done(function () {
                WHMCS.http.jqClient.post(n, "ajax=1&" + i, function (response) {
                    if (response) {
                        // Restore the arrow icon if there are validation errors
                        jQuery("#btnCompleteProductConfig").html(t);
                        jQuery("#containerProductValidationErrorsList").html(response);
        ...
        0 == jQuery(".domain-selection-options input:checked").length && ((e = jQuery(".domain-selection-options input:first")), jQuery(e).iCheck("check"), jQuery(e).parents(".option").addClass("option-selected")),
        ...
        jQuery("#frmProductDomain").submit(function (e) {
            ...
            a.tooltip("hide"),
                ...
                ("register" == i ? jQuery(".domain-lookup-register-loader") : "transfer" == i ? jQuery(".domain-lookup-transfer-loader") : jQuery(".domain-lookup-other-loader")).show(),
                ...
                "register" == i
                    ? (n.fadeIn("fast"),
                      ...
                      (a = WHMCS.http.jqClient.post(WHMCS.utils.getRouteUrl("/domain/check"), { token: csrfToken, type: "domain", domain: r + s, sld: r, tld: s, source: "cartAddDomain" }, "json")),
                      (l = WHMCS.http.jqClient.post(WHMCS.utils.getRouteUrl("/domain/check"), { token: csrfToken, type: "spotlight", domain: r + s, sld: r, tld: s, source: "cartAddDomain" }, "json")),
                      (e = WHMCS.http.jqClient.post(WHMCS.utils.getRouteUrl("/domain/check"), { token: csrfToken, type: "suggestions", domain: r + s, sld: r, tld: s, source: "cartAddDomain" }, "json")),
                      a
                          .done(function (e) {
                              jQuery.each(e.result, function (e, t) {
                                  ...
                                  if ((n.show(), jQuery(".domain-lookup-primary-loader").hide(), "string" != typeof t && !t.error && t.isValidDomain))
                                      u.hide(),
                                          (n = t.pricing),
                                          t.isAvailable && "string" != typeof n
                                              ? (t.domainName !== t.idnDomainName && m.not(":visible") && m.slideDown(),
                                                t.preferredTLDNotAvailable && unavailableTld.show().find("strong").html(t.originalUnavailableTld),
                                                s.hide(),
                                                i.show().find("strong").html(t.domainName),
                                                a.show().find("span.price").html(n[Object.keys(n)[0]].register).end().find("button").attr("data-domain", t.domainName),
                                                d.val(t.domainName),
                                                l.val(Object.keys(n)[0]).attr("name", "domainsregperiod[" + t.domainName + "]"),
                                                f.removeAttr("disabled"))
                                              : ((i = t.originalUnavailableDomain || t.domainName), r.show().find("strong").html(i), s.hide(), "string" == typeof n && "ContactUs" == n && s.show());
                                  else {
                                      (a = !1), (d = /<br\s*\/>/);
                                        ...
                                        jQuery(".domain-lookup-spotlight-loader").hide(),
                                            ...
                                            (t.isValidDomain
                                                ? t.isAvailable && "string" != typeof i
                                                    ? (t.domainName !== t.idnDomainName && m.not(":visible") && m.slideDown(),
                                                      n.find("span.available").html(i[Object.keys(i)[0]].register).show().end().find("button.btn-add-to-cart").attr("data-domain", t.domainName).show(),
                                                      n.find("button.domain-contact-support"))
                                                    : (("string" != typeof i || "" == i ? n.find("button.unavailable") : n.find("button.domain-contact-support")).show(), n.find("span.available"))
                                                : n.find("button.invalid:hidden").show().end().find("span.available").hide().end().find("button").not("button.invalid")
                                            ).hide(),
                                            n.show();
                                    });
                          })
                                  ...
                                  : (jQuery(".suggested-domains").show(),
                                    ...
                                    jQuery.each(e.result, function (e, t) {
                                        ...
                                        a
                                            ...
                                            t.domainName !== t.idnDomainName && m.not(":visible") && m.slideDown(),
                                            "string" == typeof i
                                                ? (a.find("button.btn-add-to-cart").remove(), "" != i ? a.find("button.domain-contact-support").show().end().find("span.price").hide() : a.remove())
                                                : a.find("button.btn-add-to-cart").attr("data-domain", t.domainName).end().find("span.price").html(i[Object.keys(i)[0]].register),
                                            r <= 10 && a.show(),
                                            r++,
                                            t.group && a.find("span.promo").addClass(t.group).html(t.group.toUpperCase()).show(),
                                            0 < (furtherSuggestions = o.find("div.domain-suggestion.clone").not(":visible").length) && jQuery("div.more-suggestions").show();
                                    }),
                    ...
                    ? (jQuery("#resultDomainOption").val(i),
                      WHMCS.http.jqClient
                          .post(WHMCS.utils.getRouteUrl("/domain/check"), { token: csrfToken, type: "transfer", domain: r + s, sld: r, tld: s, source: "cartAddDomain" }, "json")
                          .done(function (e) {
                              var i, a, r, o, s, d;
                              "object" != typeof e || 0 == e.result.length
                                  ...
                                  : ((i = jQuery("#primaryLookupResult")),
                                    ...
                                    0 === Object.keys(e.result).length && (jQuery(".domain-lookup-primary-loader").hide(), i.show(), o.show()),
                                    jQuery.each(e.result, function (e, t) {
                                        var n = t.pricing;
                                        jQuery(".domain-lookup-primary-loader").hide(),
                                            i.show(),
                                            t.isRegistered
                                                ? (a.show(),
                                                  ...
                                                  s.val(t.domainName),
                                                  d.val(Object.keys(n)[0]).attr("name", "domainsregperiod[" + t.domainName + "]"),
                                                  f.removeAttr("disabled"))
                                                : o.show();
                                    }));
                          })
                    ...
                    : ("owndomain" != i && "subdomain" != i && "incart" != i) ||
                      WHMCS.http.jqClient
                          .post(WHMCS.utils.getRouteUrl("/domain/check"), { token: csrfToken, type: i, pid: d, domain: r + s, sld: r, tld: s, source: "cartAddDomain" }, "json")
                          .done(function (e) {
                              "object" != typeof e || 0 == e.result.length
                                  ? jQuery(".domain-lookup-subdomain-loader").hide()
                                  : jQuery.each(e.result, function (e, t) {
                                        !0 === t.status
                                            ? displayRecommendations(whmcsBaseUrl + "/cart.php", "addproductajax=1&a=confproduct&i=" + t.num, !1).done(function () {
                                                  window.location = whmcsBaseUrl + "/cart.php?a=confproduct&i=" + t.num;
                                              })
                                            : (jQuery(".domain-lookup-primary-loader").hide(),
                                              ("string" == typeof t ? jQuery("#primaryLookupResult").show().find(".domain-error").text(t) : jQuery("#primaryLookupResult").show().find(".domain-invalid")).show());
                                    });
                          })
                          .always(function () {
                              hasProductDomainLookupEnded(1, t);
        ...
        jQuery("#frmProductDomainSelections").on("submit", function (e) {
            ...
            e.preventDefault(),
                displayRecommendations(i.attr("action"), "addproductajax=1&" + i.serialize(), !1).done(function () {
        ...
        jQuery(".account-select").on("ifChecked", function (e) {
            ...
            r.length && r.html(""),
                ...
                jQuery("#containerExistingAccountSelect").find("div.account.active").removeClass("active"),
                ...
                "new" === i
                    ? t.not(":visible") &&
                      ...
                      n.attr("required", "required").removeClass("requiredAttributeRemoved")
                    : (a.addClass("disabled"),
                      a.hasClass("spinner-on-click") && ((o = a.find("i.fas,i.far,i.fal,i.fab")), jQuery(o).data("original-class", o.attr("class")).removeAttr("class").addClass("fas fa-spinner fa-spin")),
                      jQuery("#inputCustType").val("account"),
                      t.is(":visible") && (t.slideUp(), n.attr("required") && n.removeAttr("required").addClass("requiredAttributeRemoved"), jQuery(".marketing-email-optin").slideUp())),
                WHMCS.http.jqClient.jsonPost({
                    ...
                    success: function (e) {
                        ...
                        jQuery("#totalCartPrice").text(e.total),
                            ...
                            !e.canUseCreditOnCheckout && a.is(":visible")
                                ? ((t = jQuery("#skipCreditOnCheckout")), a.hide(), t.prop("checked", !0))
                                : e.canUseCreditOnCheckout &&
                                  ((t = jQuery("#useCreditOnCheckout")),
                                  (n = jQuery("#spanFullCredit")),
                                  (i = jQuery("#spanUseCredit")),
                                  e.full
                                      ? ((hideCvcOnCheckoutForExistingCard = "1"), n.show().find("span").text(e.total), i.is(":visible") && i.slideUp())
                                      : ((hideCvcOnCheckoutForExistingCard = "0"), i.show().find("span").text(e.creditBalance), n.is(":visible") && n.slideUp()),
                                  t.iCheck("check"),
                                  a.not(":visible")) &&
                                  a.slideDown(),
                            r.length &&
            ...
            (jQuery(document).on("ifChecked", ".existing-card", function (e) {
                d.slideUp().find("input").attr("disabled", "disabled"),
                    1 !== jQuery(".payment-methods:checked").data("remote-inputs") &&
                        (i.slideUp().find("input").attr("disabled", "disabled"), "1" !== hideCvcOnCheckoutForExistingCard ? h.slideDown().find("input").removeAttr("disabled") : h.slideUp().find("input").attr("disabled", "disabled"));
            }),
            p.on("ifChecked", function (e) {
                d.slideDown().find("input").removeAttr("disabled"),
                    1 !== jQuery(".payment-methods:checked").data("remote-inputs") && (i.slideDown().find("input").removeAttr("disabled"), h.slideUp().find("input").attr("disabled", "disabled"));
            }),
            { _source: "checkout" }),
        t =
            (jQuery(".payment-methods")
                .each(function () {
                    var e = jQuery(this);
                ...
                .on("ifChecked", function (e) {
                    ...
                    a.length || h.slideUp().find("input").attr("disabled", "disabled"),
                        jQuery(this).hasClass("is-credit-card")
                            ? ((o = jQuery(this).data("payment-type")),
                              (s = jQuery(this).val()),
                              (d = jQuery(this).data("show-local")),
                              (l = []),
                              "RemoteCreditCard" === o ? c.hide().find("input").prop("disabled", "disabled") : c.not(":visible") && c.slideDown().find("input").removeProp("disabled"),
                              a.each(function (e) {
                              ...
                              (a = l.filter(function (e) {
                                  ...
                                  ? ((i = null),
                                    ...
                                    u.show(),
                                    "1" !== hideCvcOnCheckoutForExistingCard ? h.show().find("input").removeAttr("disabled") : h.hide().find("input").attr("disabled", "disabled"))
                                  : (jQuery(p).iCheck("check"), u.hide(), h.hide().find("input").attr("disabled", "disabled")),
                              f.is(":visible") ? n.complete() : f.slideDown(n))
                            : f.slideUp(n);
                }),
            ...
            "function" == typeof registerFormPasswordStrengthFeedback
                ...
                : jQuery("#inputNewPassword1").keyup(function () {
                      (passwordStrength = getPasswordStrength(jQuery(this).val())),
                          (cssClass = 75 <= passwordStrength ? ((textLabel = langPasswordStrong), "success") : 30 <= passwordStrength ? ((textLabel = langPasswordModerate), "warning") : ((textLabel = langPasswordWeak), "danger")),
            ...
            jQuery("#frmDomainChecker").submit(function (e) {
                var t, o, p, n, i;
                e.preventDefault(),
                    (void 0 !== recaptchaValidationComplete && void 0 !== recaptchaType && "invisible" === recaptchaType && !1 === recaptchaValidationComplete) ||
                        ((e = jQuery("#frmDomainChecker")),
                        (t = jQuery("#inputDomain")),
                        (o = jQuery("#domainSuggestions")),
                        (n = jQuery("#divDynamicRecaptcha")),
                        (i = jQuery("#inputCaptcha")),
                        (p = jQuery("#idnLanguageSelector")),
                        jQuery(".field-error-msg").hide(),
                        p.is(":visible") && (p.slideUp(), p.find("select").val("")),
                        (domainLookupCallCount = 0),
                        t.val()
                            ? (t.tooltip("hide"),
                              jQuery("#captchaContainer").length
                                  ...
                                  : (n.tooltip("hide"),
                                    ...
                                    (n = WHMCS.http.jqClient.post(WHMCS.utils.getRouteUrl("/domain/check"), e.serialize() + "&type=domain", "json")),
                                    (i = WHMCS.http.jqClient.post(WHMCS.utils.getRouteUrl("/domain/check"), e.serialize() + "&type=spotlight", "json")),
                                    (e = WHMCS.http.jqClient.post(WHMCS.utils.getRouteUrl("/domain/check"), e.serialize() + "&type=suggestions", "json")),
                                    n
                                        .done(function (e) {
                                            "object" != typeof e || 0 == e.result.length
                                                ? jQuery(".domain-lookup-primary-loader").hide()
                                                : jQuery.each(e.result, function (e, t) {
                                                      ...
                                                      if ((jQuery(".domain-lookup-primary-loader").hide(), n.find(".btn-add-to-cart").removeClass("checkout"), n.show(), "string" != typeof t && !t.error && t.isValidDomain))
                                                          (n = t.pricing),
                                                              o.hide(),
                                                              r.hide(),
                                                              s.hide(),
                                                              ...
                                                              l.hide(),
                                                              t.isAvailable && "string" != typeof n
                                                                  ? (t.domainName !== t.idnDomainName && p.not(":visible") && p.slideDown(),
                                                                    t.preferredTLDNotAvailable && s.show().find("strong").html(t.originalUnavailableTld),
                                                                    i.show().find("strong").html(t.domainName),
                                                                    a.show().find("span.price").html(n[Object.keys(n)[0]].register).end().find("button").attr("data-domain", t.domainName))
                                                                  : (i.hide(),
                                                                    a.hide(),
                                                                    r.hide(),
                                                                    t.preferredTLDNotAvailable ? s.show().find("strong").html(t.originalUnavailableTld) : o.show().find("strong").html(t.domainName),
                                                                    "string" == typeof n && "ContactUs" == n && r.show());
                                                      else {
                                                          ...
                                                          (t.isValidDomain
                                                              ? t.isAvailable && "string" != typeof i
                                                                  ? (t.domainName !== t.idnDomainName && p.not(":visible") && p.slideDown(),
                                                                    ...
                                                                    n.find("button.domain-contact-support"))
                                                                  : ("string" == typeof i
                                                                        ? (("" == i ? n.find("button.unavailable") : n.find("button.domain-contact-support")).show(), n.find("button.invalid").hide(), n)
                                                                        : n.find("button.invalid").hide().end().find("button.unavailable").show().end()
                                                                    ).find("span.available")
                                                              : n.find("button.invalid:hidden").show().end().find("span.available").hide().end().find("button").not("button.invalid")
                                                          ).hide(),
                                                          n.show();
                                                ...
                                                : (jQuery(".suggested-domains").show(),
                                                  ...
                                                  jQuery.each(e.result, function (e, t) {
                                                      ...
                                                      a
                                                          ...
                                                          r <= 10 && a.show(),
                                                          r++,
                                                          t.group && (a.find("span.promo").addClass(t.group).show(), a.find("span.sales-group-" + t.group).show()),
                                                          0 < (furtherSuggestions = o.find("div.domain-suggestion.clone:hidden").length) && jQuery("div.more-suggestions").show();
                                                  }),
                                                  jQuery(".domain-lookup-suggestions-loader").hide(),
                                                  jQuery("#domainSuggestions").show());
                                        })
                    ...
                    : ((t = jQuery(this).attr("data-domain")),
                      ...
                      d.is(":visible") && !s.val()
                          ...
                          : (n.find("span.to-add").hide(),
                            ...
                            (d = 0 < jQuery(this).parents(".spotlight-tlds").length || 0 < jQuery(this).parents(".suggested-domains").length ? 1 : 0),
                            WHMCS.http.jqClient.post(whmcsBaseUrl + "/cart.php", { a: "addToCart", domain: t, token: csrfToken, whois: e, sideorder: d, idnlanguage: s.val() }, "json").done(function (e) {
                                n.find("span.loading").hide(),
                                    "added" === e.result
                                        ? (n.find("span.added").show(),
                                          i || n.removeAttr("disabled").addClass("checkout"),
                                          r.length && !r.val() && (r.val(t), o.val(e.period).attr("name", "domainsregperiod[" + t + "]"), 0 < a.length) && a.is(":disabled") && a.removeAttr("disabled"),
                                          jQuery("#cartItemCount").html(e.cartCount))
                                        : (n.find("span.available.price").hide(), n.find("span.unavailable").show(), n.attr("disabled", "disabled"));
                            })));
            }),
                ...
                if ((e.preventDefault(), void 0 === recaptchaValidationComplete || void 0 === recaptchaType || "invisible" !== recaptchaType || !1 !== recaptchaValidationComplete)) {
                    ...
                    n.tooltip("hide"),
                        jQuery("#captchaContainer").length
                            ...
                            : (s.tooltip("hide"),
                              d.tooltip("hide"),
                              t.attr("disabled", "disabled").addClass("disabled").find("span").show().end().find(".loader").show(),
                              WHMCS.http.jqClient
                                  ...
                                  .done(function (e) {
                                      ...
                                      e = e.result;
                                      "added" == e
                                          ? ((window.location = whmcsBaseUrl + "/cart.php?a=confdomains"), (o = !0))
                                          : 1 == e.isRegistered
        ...
        l =
            (t.on("ifChecked", function () {
                var e = jQuery("#useCreditOnCheckout"),
                    ...
                    d = !0;
                e.prop("checked") &&
                    (s.is(":hidden") && (d = !1), t && 0 !== i.length ? (i.iCheck("check"), o.slideUp(), d && a.slideUp()) : !t && a.is(":visible") ? d && a.slideUp() : (d && !t) || a.is(":visible") || (o.slideDown(), a.slideDown()), t) &&
                    "new" !== n.val() &&
                    (s.is(":visible") ? ((hideCvcOnCheckoutForExistingCard = "1"), r.hide().find("input").attr("disabled", "disabled")) : r.show().find("input").removeAttr("disabled"));
            }),
    ...
    l.is(":visible") && 1 === l.data("apply-credit") && t.length && (e.iCheck("check"), t.iCheck("check")),
        ...
        jQuery(".btn-add-renewal-to-cart").on("click", function () {
            var e,
                ...
                i = n.outerWidth();
            (t =
                1 <= jQuery("#serviceRenewals").length
                    ? ((e = (e = n.data("service-id")).toString().startsWith("a-") ? WHMCS.utils.getRouteUrl("/cart/service/" + e.substr(2) + "/addon/renew") : WHMCS.utils.getRouteUrl("/cart/service/" + e + "/product/renew")),
                      { token: csrfToken })
                    : ((t = n.data("domain-id")), (e = WHMCS.utils.getRouteUrl("/cart/domain/renew/add")), { domainId: t, period: jQuery("#renewalPricing" + t).val(), token: csrfToken })),
                n.hasClass("checkout")
        ...
        jQuery(document).on("submit", "#removeRenewalForm", function (e) {
            e.preventDefault();
            var t = "#renewDomain";
            1 <= jQuery("#serviceRenewals").length && (t = "#renewService"),
                WHMCS.http.jqClient
        ...
        jQuery("#serviceRenewalFilter").on("input", function () {
            function i(e, n) {
                var i = !1;
                return (
                    0 < a.length && jQuery("#hideShowServiceRenewalButton").find("span.to-show").hide().end().find("span.to-hide").show().end().removeAttr("disabled"),
            ...
            jQuery("#serviceRenewals")
                .find(".service-renewal")
                .filter(function () {
                    var e = jQuery(this),
                        t = e.find(".addon-renewals"),
                        n = !1;
                    0 < t.length &&
                        t.find(".service-renewal").filter(function () {
                            n = i(jQuery(this), a);
                        }),
                        n ? e.toggle(!0) : i(e, a),
                        t.toggle(n);
        ...
        jQuery(this).find("span.to-hide").hide().end().find("span.to-show").show().end().removeAttr("disabled"),
        hideNoneRenewableServices(),
        jQuery("#hideShowServiceRenewalButton").on("click", function () {
            (jQuery(this).find("span.to-show").is(":hidden")
                ? (jQuery(this).find("span.to-hide").hide().end().find("span.to-show").show().end().removeAttr("disabled"), hideNoneRenewableServices)
                : (jQuery(this).find("span.to-show").hide().end().find("span.to-hide").show().end().removeAttr("disabled"), showNoneRenewableServices))();
        }),
        (checkoutForm = jQuery("#frmCheckout")).length &&
            (checkoutForm.on("submit", validateCheckoutCreditCardInput),
            checkoutForm.on("submit.paymentjs", function (e) {
                WHMCS.payment.event.checkoutFormSubmit({ ...m, event: e }, WHMCS.payment.event.previouslySelected.module, jQuery(this));
            })),
        jQuery(".payment-methods:checked").trigger("ifChecked"),
