...
$targets = [
    ...
    'usage controller file' => [
        ...
        'markers' => [
            ...
            'deterministic usage timestamp helper marker' => 'function eb_usage_record_timestamp_for_period(int $periodStart, int $periodEnd): int',
            ...
            'deterministic usage timestamp marker' => '$usageTimestamp = eb_usage_record_timestamp_for_period($resolvedPeriodStart, $resolvedPeriodEnd);',
