          ...
          <div class="mb-4 flex flex-col xl:flex-row xl:items-center gap-3">
            ...
            <div class="relative" @click.away="columnsOpen=false">
              ...
              <div x-show="columnsOpen"
                ...
                <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Type</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.type"></label>
                <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Size</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.size"></label>
              </div>
            </div>
            ...
            <div class="mb-4 flex flex-col xl:flex-row xl:items-center gap-3">
                ...
                <div class="relative" @click.away="columnsOpen=false">
                    ...
                    <div x-show="columnsOpen"
                        ...
                        <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Device Name</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.name"></label>
                        <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Device ID</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.id"></label>
                        <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Registered</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.reg"></label>
                        <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Version</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.ver"></label>
                        <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Platform</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.plat"></label>
                        <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Protected Items</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.items"></label>
                        <label class="flex items-center justify-between rounded px-2 py-2 text-sm hover:bg-slate-800/60 cursor-pointer"><span>Actions</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.actions"></label>
                    </div>
                </div>
                    ...
                    <div class="relative shrink-0" @click.away="open=false">
                        ...
                        <div x-show="open" x-transition class="absolute mt-2 w-72 rounded-xl border border-slate-700 bg-slate-900 shadow-2xl z-10 p-2">
                            <div class="grid grid-cols-2 gap-1 text-sm text-slate-200">
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Username</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.user"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Job ID</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.id"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Device</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.device"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Protected Item</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.item"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Storage Vault</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.vault"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Version</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.ver"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Type</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.type"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Status</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.status"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Directories</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.dirs"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Files</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.files"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Size</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.size"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Storage Vault Size</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.vsize"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Uploaded</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.up"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Downloaded</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.down"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Started</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.started"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Ended</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.ended"></label>
                                <label class="flex items-center justify-between rounded px-2 py-2 hover:bg-slate-800/60 cursor-pointer"><span>Duration</span><input type="checkbox" class="rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-sky-500" x-model="cols.dur"></label>
                            </div>
                        </div>
                    </div>
