...
<div class="flex justify-center items-center min-h-screen bg-gray-700" x-data="{ openModal: null }" @keydown.escape="openModal = null">
    <div class="bg-gray-800 shadow rounded-lg p-6 text-center max-w-4xl">
        <h1 class="text-2xl text-gray-100 font-semibold mb-6">Your new {if isset($whitelabel_product_name) && $whitelabel_product_name neq "OBC"} {$whitelabel_product_name} {/if} account is ready</h1>
        <div class="signup-content">
            ...
            <div class="download">
                <p class="text-md text-gray-100 mb-6">
                    Download your branded client installer using the buttons below.<br>
               ...
               <div class="dialog-content mini-downloads-widget">
                    ...
                    <div class="flex justify-center divide-x divide-orange-700">
                        <!-- Windows Button -->
                        <button 
                            @click="openModal = 'windows'" 
                            class="flex items-center bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white font-semibold py-2 px-4 text-sm rounded-l-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500">
                        ...
                        <button 
                            ...
                            class="flex items-center bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white font-semibold py-2 px-4 text-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500">
                        ...
                        <button 
                            ...
                            class="flex items-center bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white font-semibold py-2 px-4 text-sm rounded-r-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500">
                    ...
                    <div class="flex space-x-2 mt-2">
                        ...
                        <div class="relative group">
                            ...
                            <span class="tooltip-content">
                                Includes the desktop app.
                            </span>
                        </div>
                        <div class="relative group">
                            <i class="fas fa-terminal text-gray-100"></i>
                            <span class="tooltip-content">
                                Includes the command-line client.
                            </span>
                        </div>
                        <div class="relative group">
                            <i class="fas fa-globe text-gray-100"></i>
                            <span class="tooltip-content">
                                Can be controlled and configured from the web admin interface.
                            </span>
                        </div>
                    </div>
                </div>
                <div class="download-button-container dl-windows my-4 flex flex-wrap justify-start">
                    <a class="flex items-center bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold py-2 px-4 rounded m-1" href="https://{$serverHostname}/dl/1">
                        <i class="fa-solid fa-file-arrow-down mr-2"></i> Any CPU
                    </a>
                    <a class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded m-1" href="https://{$serverHostname}/dl/5">
                        <i class="fa-solid fa-file-arrow-down mr-2"></i> x86_64 only
                    </a>
                    <a class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded m-1" href="https://{$serverHostname}/dl/3">
            ...
            <div class="p-6">
                <div class="mb-4">
                    ...
                    <div class="flex space-x-2 mt-2">
                        ...
                        <div class="relative group">
                            <i class="fas fa-desktop text-gray-100"></i>
                            <span class="tooltip-content">
                                Includes the Linux desktop app with GUI.
                            </span>
                        </div>
                        <div class="relative group">
                            <i class="fas fa-terminal text-gray-100"></i>
                        ...
                        <div class="relative group">
                            <i class="fas fa-globe text-gray-100"></i>
                            <span class="tooltip-content">
                                Can be controlled and configured from the Control Panel interface.
                            </span>
                        </div>
                    </div>
                </div>
                <div class="download-button-container dl-linux my-4">
                    ...
                    <div class="flex items-center mb-4 flex-wrap">
                        <!-- Download Button -->
                        <a class="flex items-center bg-orange-400 hover:bg-orange-600 text-white text-sm font-semibold py-2 px-4 rounded mr-3 mb-2" href="https://{$serverHostname}/dl/21">
                            <i class="fa-solid fa-file-arrow-down mr-2"></i> Download
                        </a>
                        <!-- Copy Buttons -->
                        <button class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded mr-2 mb-2 copy-btn" data-clipboard-text="curl -O -J -d 'SelfAddress=https%3A%2F%2F{$serverHostname}%2F&Platform=21' -X POST 'https://{$serverHostname}/api/v1/admin/branding/generate-client/by-platform'">
                            <i class="fa-regular fa-copy mr-1"></i> Copy as cURL
                        </button>
                        <button class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded mb-2 copy-btn" data-clipboard-text="wget --content-disposition --post-data 'SelfAddress=https%3A%2F%2F{$serverHostname}%2F&Platform=21' 'https://{$serverHostname}/api/v1/admin/branding/generate-client/by-platform'">
                    ...
                    <div class="flex items-center mb-4 flex-wrap">
                        <!-- Download Button -->
                        <a class="flex items-center bg-orange-400 hover:bg-orange-600 text-white text-sm font-semibold py-2 px-4 rounded mr-3 mb-2" href="https://{$serverHostname}/dl/7">
                            <i class="fa-solid fa-file-arrow-down mr-2"></i> Download
                        </a>
                        <!-- Copy Buttons -->
                        <button class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded mr-2 mb-2 copy-btn" data-clipboard-text="curl -O -J -d 'SelfAddress=https%3A%2F%2F{$serverHostname}%2F&Platform=7' -X POST 'https://{$serverHostname}/api/v1/admin/branding/generate-client/by-platform'">
                            <i class="fa-regular fa-copy mr-1"></i> Copy as cURL
                        </button>
                        <button class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded mb-2 copy-btn" data-clipboard-text="wget --content-disposition --post-data 'SelfAddress=https%3A%2F%2F{$serverHostname}%2F&Platform=7' 'https://{$serverHostname}/api/v1/admin/branding/generate-client/by-platform'">
                            <i class="fa-regular fa-copy mr-1"></i> Copy as wget
                        </button>
                    </div>
                </div>
        ...
        <div @click.away="openModal = null" class="bg-gray-800 rounded-lg w-full max-w-3xl mx-4">
            ...
            <div class="p-6">
                ...
                <div class="download-button-container dl-macos my-4 flex flex-wrap">
                    <a class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded m-1" href="https://{$serverHostname}/dl/8">
                        <i class="fa-solid fa-file-arrow-down mr-2"></i> x86_64
                    </a>
                    <a class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded m-1" href="https://{$serverHostname}/dl/20">
        ...
        <div @click.away="openModal = null" class="bg-gray-800 rounded-lg w-full max-w-3xl mx-4">
            ...
            <div class="p-6">
                ...
                <div class="download-button-container dl-synology my-4 flex flex-wrap">
                    <a class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded m-1" href="https://{$serverHostname}/dl/18">
                        <i class="fa-solid fa-file-arrow-down mr-2"></i> DSM 6
                    </a>
                    <a class="flex items-center bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold py-2 px-4 rounded m-1" href="https://{$serverHostname}/dl/19">
