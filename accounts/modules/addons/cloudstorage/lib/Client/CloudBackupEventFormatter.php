...
class CloudBackupEventFormatter
{
    ...
    private static function dictionary()
    {
        return [
            ...
            'KOPIA_RETENTION_START' => 'Applying retention policy (keep last {keep_last} backups).',
            'KOPIA_RETENTION_COMPLETE' => 'Retention complete: removed {deleted_count} old backup(s), keeping {keep_last}.',
            'KOPIA_RETENTION_FAILED' => 'Retention policy could not be applied: {error}.',
            ...
            'DISK_IMAGE_DRIVER_BUNDLE_PRESENT' => 'Driver bundle already exists in destination; capture skipped.',
            'DISK_IMAGE_DRIVER_BUNDLE_READY' => 'Driver bundle captured for recovery media.',
            'DISK_IMAGE_DRIVER_BUNDLE_SKIPPED' => 'Driver bundle capture failed - contact support.',
