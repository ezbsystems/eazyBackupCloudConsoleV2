...
>
    <div class="flex h-full flex-col">
        ...
        <nav class="flex-1 space-y-1 overflow-y-auto px-3 py-3">
            ...
            <a href="index.php?m=cloudstorage&page=e3backup&view=ms365" class="eb-sidebar-link {if $activeNav eq 'ms365'}is-active{/if}" :class="sidebarCollapsed && 'justify-center px-4'" :title="sidebarCollapsed ? 'Microsoft 365' : ''">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5 12 3 3.75 7.5 12 12l8.25-4.5ZM3.75 16.5 12 21l8.25-4.5M3.75 12 12 16.5 20.25 12" />
                </svg>
                <span x-show="!sidebarCollapsed" x-transition.opacity>Microsoft 365</span>
            </a>
