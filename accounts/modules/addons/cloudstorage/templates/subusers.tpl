<!-- accounts/templates/eazyBackup/access_keys.tpl -->
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
            ...
            <div class="flex items-center mt-4 sm:mt-0">
                ...
                <div class="relative">
                    <button
                        class="flex items-center bg-gray-700 hover:bg-gray-600 text-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                        id="user-menu-button"
                        aria-expanded="false"
                        aria-haspopup="true"
                        onclick="toggleDropdown()"
                    >
                        <!-- Person Circle Icon SVG -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <!-- Dropdown Menu -->
                    <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-md shadow-lg z-20">
                        <a href="logout.php" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Log out</a>
                        <a href="https://accounts.eazybackup.ca/" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Client area</a>
                    </div>
                </div>
            </div>
        </div>

        <!-- Service URL Display (Engage!) -->
        <div class="mb-8 bg-gray-800 rounded-md shadow-lg p-4 flex items-center justify-between">
            <div class="flex items-center">
                <span class="text-lg font-semibold text-white mr-2">Service URL:</span>
                <input type="text" id="serviceURL" value="s3.ca-central-1.eazybackup.com" class="bg-gray-700 text-gray-300 border border-gray-600 rounded-md px-3 py-2 min-w-[300px]" readonly>
            </div>
            <button
        ...
        <!-- Access Keys Table -->
        <div class="container mt-3 bg-gray-800 rounded-lg shadow-lg p-6">
                        ...
                        {if $accessKey !== null}
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap relative">
                                    <input type="password" value="{$accessKey->access_key}" class="w-full bg-gray-700 text-gray-300 border border-gray-600 rounded-md px-3 py-2" id="accessKey" readonly>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap relative">
                                    <input type="password" value="{$accessKey->secret_key}" class="w-full bg-gray-700 text-gray-300 border border-gray-600 rounded-md px-3 py-2" id="secretKey" readonly>
                                    <!-- Copy Icon (initially hidden until decryption) -->
                                    <button
                                        class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-300 hidden"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex space-x-2">
                                        ...
                                        <button
                                            type="button"
                                            class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                            id="decryptKeys"
                                        ...
                                        <button
                                            type="button"
                                            class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400"
        ...
        <div class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 hidden" id="passwordModal">
            <div class="bg-gray-800 rounded-lg shadow-lg w-full max-w-lg p-6">
                ...
                <div>
                    ...
                    <button
                        type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 mt-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                        id="submitPassword"
                    >
                        Submit
                    </button>
