<?php
/**
 * Poll whether a recovery restore run has cancel_requested.
 */
...
$cancelRequested = !empty($run->cancel_requested);
respond(['status' => 'success', 'cancel_requested' => $cancelRequested]);
