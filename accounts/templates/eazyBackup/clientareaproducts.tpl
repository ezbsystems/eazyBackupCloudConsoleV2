    ...
    <div class="eb-page-inner">
        <div class="eb-panel">
            ...
            <div class="eb-page-header">
                ...
                <div class="shrink-0">
                    <a href="modules/servers/comet/ajax/export_usage.php" class="eb-btn eb-btn-primary">
            ...
            <div id="services-wrapper" class="eb-subpanel">
                <div class="table-container clearfix">                
                    ...
                    <div id="successMessage" 
                        tabindex="-1"
                        class="eb-alert eb-alert--success hidden justify-center text-center"
                        role="alert">
                    </div>
                    <div id="errorMessage" 
                        tabindex="-1"
                        class="eb-alert eb-alert--danger hidden justify-center text-center"
                        role="alert">
                    </div>
                            ...
                            <div class="eb-table-toolbar">
                                ...
                                <div class="relative"
                                    ...
                                    <div x-show="isOpen"
                                         ...
                                         x-transition:leave-start="opacity-100 scale-100"
                                         x-transition:leave-end="opacity-0 scale-95"
                                         class="eb-menu absolute left-0 z-50 mt-2 w-56 overflow-hidden"
                                         style="display: none;">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        {foreach key=num item=service from=$filteredServices}
                                            ...
                                            >
                                                <td class="service_username serviceid-{$service.id}" data-id="{$service.id}">
                                                    <span class="eb-table-primary">{$service.username}</span>
                                                </td>
                                                <td>{$service.product}</td>
                                                <td>
                                                    <span class="eb-badge {if strtolower($service.status) == 'active'}eb-badge--success{else}eb-badge--neutral{/if} eb-badge--dot">
                                                ...
                                                <td class="whitespace-nowrap text-sm">
                                                    <div x-data="{ isOpen: false }" class="relative inline-block text-left" @keydown.escape="isOpen = false">
                                                        <button type="button"
                                                                class="open-vault-panel eb-btn eb-btn-secondary eb-btn-xs cursor-pointer"
                                                                @click="isOpen = !isOpen"
                                                        ...
                                                        <div x-show="isOpen"
                                                             ...
                                                             class="eb-menu absolute right-0 z-50 mt-2 w-48 origin-top-right"
                                                             role="menu"
                                                             style="display: none;">
            ...
            <div class="eb-billing-report-shell">
                
                <div id="billing-report-wrapper" class="eb-subpanel overflow-hidden" style="display:none;">
                        ...
                        <div class="mb-4 flex flex-col xl:flex-row xl:items-center gap-3">
                            ...
                            <div class="relative" @keydown.escape="showMenu=false">
                                ...
                                <div x-show="showMenu" x-transition
                                    class="eb-menu absolute left-0 z-50 mt-2 max-h-64 w-64 overflow-auto p-2"
