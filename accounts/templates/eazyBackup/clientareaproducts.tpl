                                            ...
                                            >
                                                ...
                                                <td class="px-4 py-3 text-left whitespace-nowrap text-sm">
                                                    <div x-data="{ isOpen: false }" class="relative inline-block text-left" @keydown.escape="isOpen = false">
                                                        <button type="button"
                                                                class="open-vault-panel px-3 py-1.5 text-xs bg-slate-700 rounded text-white hover:bg-slate-600 cursor-pointer"
                                                                @click="isOpen = !isOpen"
                                                        ...
                                                        <div x-show="isOpen"
                                                             ...
                                                             class="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md border border-slate-700 bg-slate-800 shadow-lg"
                                                             role="menu"
                                                             style="display: none;">
