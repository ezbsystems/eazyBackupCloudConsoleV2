...
{literal}
    ...
    {literal}
        <script>
          ...
          /**
           * Row actions menu: teleports to body + fixed positioning so it is not
           * clipped by .eb-table-shell overflow-x-auto.
           */
          window.serviceRowActionsDropdown = function() {
            return {
              isOpen: false,
              menuPositionStyle: '',
              MENU_WIDTH_PX: 192,
                        ...
                        <tbody>
                            {foreach key=num item=service from=$filteredServices}
                                <tr id="serviceid-{$service.id}">
                                    ...
                                    <td class="text-right">
                                        <div class="inline-flex justify-end" x-data="serviceRowActionsDropdown()">
                                            <button type="button"
                                                    x-ref="trigger"
                                            ...
                                            <template x-teleport="body">
                                                <div x-show="isOpen"
                                                     ...
                                                     x-transition:leave-start="opacity-100 scale-100"
                                                     x-transition:leave-end="opacity-0 scale-95"
                                                     class="eb-dropdown-menu fixed z-[2100] w-48 overflow-hidden"
                                                     style="display: none;"
