<div class="main-section-header-tabs rounded-t-xl border-b border-slate-700 bg-slate-800 pt-4 px-2">
    ...
    <div id="menu" class="hidden [@media(min-width:1060px)]:flex">
        <ul class="flex flex-nowrap justify-start space-x-0 [@media(max-width:1160px)]:space-x-0 [@media(min-width:1161px)]:space-x-2">
            ...
            <li>
                <a href="{$WEB_ROOT}/clientarea.php?action=details" 
                   class="flex items-center py-2 px-2 [@media(max-width:1160px)]:px-2 [@media(min-width:1161px)]:px-3 
                          text-gray-100 block text-sm text-gray-100 hover:border-b-2 hover:border-gray-600
                    ...
                    <span class="block font-medium text-gray-100 text-gray-100">Profile</span>
                </a>
            </li>
            ...
            <li>
                <a href="{$WEB_ROOT}/index.php?m=eazybackup&a=notify-settings" 
                   class="flex items-center py-2 px-2 [@media(max-width:1160px)]:px-2 [@media(min-width:1161px)]:px-3
                    ...
                    <span class="block font-medium text-gray-100 whitespace-nowrap text-gray-100">Notifications</span>
                </a>
            </li>            
            ...
            <li>
                ...
                class="flex items-center py-2 px-2 [@media(max-width:1160px)]:px-2 [@media(min-width:1161px)]:px-3
                        text-gray-100 block text-sm hover:border-b-2 hover:border-gray-600
                ...
                {/if}>
                    ...
                    <span class="block font-medium text-gray-100 whitespace-nowrap text-gray-100">Payment Details</span>
                </a>
            </li>
            ...
            <li>
                <a href="{$WEB_ROOT}/index.php?rp=/user/security" 
                   class="flex items-center py-2 px-2 [@media(max-width:1160px)]:px-2 [@media(min-width:1161px)]:px-3
                    ...
                    <span class="block font-medium text-gray-100 whitespace-nowrap text-gray-100">Security</span>
                </a>
            </li>
            ...
            <li>
                <a href="{$WEB_ROOT}/index.php?rp=/user/password" 
                   class="flex items-center py-2 px-2 [@media(max-width:1160px)]:px-2 [@media(min-width:1161px)]:px-3 
                    ...
                    <span class="block font-medium text-gray-100 whitespace-nowrap text-gray-100">Change Password</span>
                </a>
            </li>
            ...
            <li>
                ...
                {/if}>                   
                    ...
                    <span class="block font-medium text-gray-100 text-gray-100">Contacts</span>
                </a>
            </li>
            ...
            <li>
                ...
                {/if}>      
                    ...
                    <span class="block font-medium text-gray-100 text-gray-100">Users</span>
                </a>
            </li>
            ...
            <li>
                <a href="{$WEB_ROOT}/index.php?m=eazybackup&a=terms" 
                   class="flex items-center py-2 px-2 [@media(max-width:1160px)]:px-2 [@media(min-width:1161px)]:px-3
                          text-gray-100 block text-sm text-gray-100 hover:border-b-2 hover:border-gray-600
                          {if $smarty.get.m == 'eazybackup' && $smarty.get.a == 'terms'} 
                          text-sky-600 border-b-2 border-sky-600 
                          {/if}"
                {if $smarty.get.m == 'eazybackup' && $smarty.get.a == 'terms'} 
                    aria-current="page" 
                {/if}>
                    ...
                    <span class="block font-medium text-gray-100 text-gray-100">Terms</span>
                </a>
            </li> 
        </ul>
    </div>
...
<div id="mobile-menu" class="fixed inset-0 z-50 hidden">
    ...
    <div id="profile-nav"
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b">
            <h2 class="text-lg block font-medium text-gray-100 text-gray-100">My Account</h2>
        ...
        <ul class="p-4 space-y-4">
            ...
            <li>
                <a href="{$WEB_ROOT}/clientarea.php?action=details" 
                class="flex items-center space-x-3 text-gray-100 hover:text-sky-600
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        stroke-width="1.5" 
                        stroke="currentColor" 
                        class="w-6 h-6 text-gray-100 hover:text-sky-600">
                    ...
                    <!-- Text Content -->
                    <div>
                        <span class="block font-medium text-gray-100">Profile</span>
                        <p class="block text-sm text-gray-100">View and update your profile details.</p>
                    </div>
                </a>
            </li>
            ...
            <li>
                ...
                class="flex items-center space-x-3 text-gray-100 hover:text-sky-600
                    ...
                    <!-- Text Content -->
                    <div>
                        <span class="block font-medium text-gray-100">Payment Details</span>
                        <p class="block text-sm text-gray-100">Manage your payment methods.</p>
                    </div>
                </a>
            </li>
            ...
            <li>
                ...
                class="flex items-center py-2 px-2 [@media(max-width:1160px)]:px-2 [@media(min-width:1161px)]:px-3
                    ...
                    <!-- Text Content -->
                    <div>
                        <span class="block font-medium text-gray-100">Security</span>
                        <p class="block text-sm text-gray-100">Configure 2FA</p>
                    </div>
                </a>
            </li>
            ...
            <li>
                ...
                class="flex items-center space-x-3 text-gray-100 hover:text-sky-600
                    ...
                    <div>
                        <span class="block font-medium text-gray-100">Password</span>
                        <p class="block text-sm text-gray-100">Update account password</p>
                    </div>
                </a>
            </li> 
            ...
            <li>
                ...
                class="flex items-center space-x-3 text-gray-100 hover:text-sky-600">
                    ...
                    <!-- Text Content -->
                    <div>
                        <span class="block font-medium text-gray-100">Contacts</span>
                        <p class="block text-sm text-gray-100">Manage your contacts.</p>
                    </div>
                </a>
            </li>  
            ...
            <li>
                ...
                class="flex items-center space-x-3 text-gray-100 hover:text-sky-600">
                    ...
                    <!-- Text Content -->
                    <div>
                        <span class="block font-medium text-gray-100">Users</span>
                        <p class="block text-sm text-gray-100">Manage user accounts.</p>
                    </div>
                </a>
            </li>
            ...
            <li>
                <a href="{$WEB_ROOT}/index.php?m=eazybackup&a=notify-settings" 
                   class="flex items-center space-x-3 text-gray-100 hover:text-sky-600">
                    ...
                    <div>
                        <span class="block font-medium text-gray-100">Notifications</span>
                        <p class="block text-sm text-gray-100">Manage email alerts & routing.</p>
                    </div>
                </a>
            </li>
        </ul>
