{* Partner Hub — single link to Partner Hub overview (whitelabel/overview.tpl via ph-overview). Full nav: sidebar_partner_hub.tpl *}
{if !isset($eb_partner_hub_enabled) || $eb_partner_hub_enabled}
<a
  href="{$WEB_ROOT}/index.php?m=eazybackup&amp;a=ph-overview"
