            ...
            <div class="eb-theme-sidebar-inner">
                    ...
                    {if $loggedin}
                        ...
                        <a id="sidebar-e3-backup-link"
                           href="{$WEB_ROOT}/{if $ebE3BackupNavUrl}{$ebE3BackupNavUrl}{else}index.php?m=cloudstorage&page=e3backup{/if}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{$WEB_ROOT}/index.php?m=cloudstorage&page=welcome&choose=ms365"
                                class="eb-flyout-card group">
                                    <!-- Icon -->
                                    <svg class="eb-flyout-card-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
